...
swansonisms <- c("There's only one thing I hate more than lying: skim milk. Which is water that's lying about being milk.",
                 ...
                 "I've cried twice in my life. Once when I was 7 and hit by a school bus. And then again when I head that Li'l Sebastian had passed.",
                 ...
                 "When I walked in this morning and saw that the flag was half-mast, I thought 'All right, another bureacrat ate it!",
                 "I like Tom. He doesn't do a lot of work around here. He shows zero initiative. He's not a team player. He's never wanted to go that extra mile. To is exactly what I'm looking for in a government employee.",
                 "The whole point of this country is if you want to eat garbage, balloon up to 600 pounds and die of a heart attack at 43, you can! You are free to do so. To me, that's beautiful",
                 "There is only bad word: taxes.",
                 ...
                 "[On bowling] 'Straight down the middle. No hook, no spin, no fuss. Anything more than this becomes figure skating.'",
                 "I would rather bleed out than sit here and talk about my feelings for 10 minutes.",
                 "Give 100 percent. One-hundred-and-ten percent is impossible. Only idiots recomend that.",
                 ...
                 "An ideal night out, to me, is stepping onto my porch area and grilling up a thich slab of something's flesh and then popping in a highlight reel from the WNBA.",
                 ...
                 "I prefer quality other flash - that's why I refuse to write my signatre in cursive.",
...
#' Ron says...
#'
#' @param n Number of quotes to return
#' @export

ron_says <- function(n=1){

  if(n > length(swansonisms)){
    stop(paste("Ron is a person of few words. Please select a number of quotes less than", length(swansonisms), sep = " "))
  }

  sample(swansonisms, size = n, replace = FALSE)
}
